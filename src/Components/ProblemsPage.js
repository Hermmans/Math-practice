...
export default function ProblemsPage() {
  return (
    <main>
      <section id="problem">
        ...
        <p>
          Problem: <span class="currentProblem">1</span>/10 | Score:{" "}
  ...
  //added this not sure what you think, but this was the code that me and partner wrote last time lol
...
function updateDisplayProblem(operands) {
  let displayProblem = document.getElementsByClassName(
